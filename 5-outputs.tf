...
output "application_url" {
  value = <<EOT
Home: http://<your-public-ipv4>:8000/
initalize DB  : http://<your-public-ipv4>:8000/init
1st note (GET): http://<your-public-ipv4>:8000/add?note=first_note
2nd note (GET): http://<your-public-ipv4>:8000/add?note=passportpookie_rising
3rd note (GET): http://<your-public-ipv4>:8000/add?note=snowbunny_season
4th note (GET): http://<your-public-ipv4>:8000/add?note=successful_blackmen 
5th note (GET): http://<your-public-ipv4>:8000/add?note=black_maagic
List: http://<your-public-ipv4>:8000/list
EOT
}
...
/* output "ec2_instance" {
  value = http://<your-public-ipv4>:800000/
}*/
