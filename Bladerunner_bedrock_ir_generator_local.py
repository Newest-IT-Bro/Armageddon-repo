...
# bladerunner loves repeatable domination: same evidence, same format, every time.
...
def main():
    if len(sys.argv) < 4:
        print("Usage: bladerunner_bedrock_ir_generator_local.py <model_id> <evidence.json> <template.md>")
        sys.exit(1)
