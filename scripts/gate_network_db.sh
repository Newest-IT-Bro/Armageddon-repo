...
usage() {
  cat <<EOF
Usage:
  REGION=eu-west-2 INSTANCE_ID=i-0c5aa4f712c66ce1b DB_ID=lab-mysql ./scripts/gate_network_db.sh

Required env vars:
  REGION       AWS region (default: eu-west-2)
  INSTANCE_ID  EC2 instance id (i-0c5aa4f712c66ce1b)
  DB_ID        RDS DB instance identifier (lab-mysql)
...
Examples:
  REGION=eu-west-2 INSTANCE_ID=i-0c5aa4f712c66ce1b DB_ID=lab-mysql ./gate_network_db.sh

  CHECK_PRIVATE_SUBNETS=true REGION=eu-west-2 INSTANCE_ID=i-0c5aa4f712c66ce1b DB_ID=lab-mysql ./gate_network_db.sh
EOF
}
