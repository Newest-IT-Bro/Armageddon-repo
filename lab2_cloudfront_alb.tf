# Explanation: CloudFront is the only public doorway — lab2 stands behind it with private infrastructure.
resource "aws_cloudfront_distribution" "lab2_cf01" {
  enabled             = true
  ...
  web_acl_id = aws_wafv2_web_acl.lab2_cf_waf01.arn

  # TODO: students set aliases for lab2-growl.com and app.lab2-growl.com
  aliases = [
