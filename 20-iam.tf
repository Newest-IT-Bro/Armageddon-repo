...
resource "aws_iam_policy" "lab2_leastpriv_read_params" {
...
resource "aws_iam_policy" "lab2_lp_read_secret01" {
...
resource "aws_iam_policy" "lab2_lp_cwlogs01" {
...
resource "aws_iam_role_policy_attachment" "attach_lp_params01" {
  ...
  policy_arn = aws_iam_policy.lab2_leastpriv_read_params.arn
}

resource "aws_iam_role_policy_attachment" "attach_lp_secret01" {
  role       = aws_iam_role.ec2_role.name
  policy_arn = aws_iam_policy.lab2_lp_read_secret01.arn
}

resource "aws_iam_role_policy_attachment" "attach_lp_cwlogs01" {
  role       = aws_iam_role.ec2_role.name
  policy_arn = aws_iam_policy.lab2_lp_cwlogs01.arn
}
